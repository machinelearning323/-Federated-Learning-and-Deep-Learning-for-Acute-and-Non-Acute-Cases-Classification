...
class FlowerClient(fl.client.NumPyClient):
    ...
    def save_metrics(self):
        ...
        np.save("client2_precision.npy", np.array(self.precision_history))
        np.save("client2_recall.npy", np.array(self.recall_history))
        np.save("client2_accuracy.npy", np.array(self.accuracy_history))

        print(f"Metrics saved for client 2")
...
if __name__ == "__main__":
    ...
    data_dir = r"C:\Users\23113181\Downloads\Annotated_stroke_and_non_stroke_Dataset\Annotated_stroke_and_non_stroke_Dataset"  # Replace with your dataset path
