...
class FlowerClient(fl.client.NumPyClient):
    ...
    def save_metrics(self):
        ...
        np.save("client1_precision.npy", np.array(self.precision_history))
        np.save("client1_recall.npy", np.array(self.recall_history))
        np.save("client1_accuracy.npy", np.array(self.accuracy_history))

        print(f"Metrics saved for client 1")
